...
function CountryDetailedInfo({ selectedCountry }) {
  ...
  if (selectedCountry.hasOwnProperty("borders")) {
    borderSegment = selectedCountry.borders.map((element, index) => {
      return (
        <p
          key={index}
          className="px-4 py-1 mr-4 shadow-md border-[0.5px] border-gray-300 dark:border-0 dark:bg-dark-mode-elements"
        >
          {element}
        </p>
      );
  ...
  return (
    <div className="dark:text-dark-mode-text px-[7.5%]">
      <Link
        to="/"
        className="px-4 py-1 shadow-md 2xl:ml-[3vw] dark:bg-dark-mode-elements"
      >
        <ion-icon
          name="arrow-back-outline"
          class="dark:text-dark-mode-text pr-3"
        ></ion-icon>
        Back
      </Link>
      ...
      <div className="lg:flex lg:flex-wrap lg:justify-between lg:items-center 2xl:justify-evenly 2xl:gap-x-[10vw] lg:gap-x-[50px] lg:mt-[5vh]">
        <img
          ...
          alt="country-flag"
          className="my-6 max-h-[350px] min-h-[150] sm:h-[30vh] md:h-[32vh] shadow-md"
        />
        ...
        <div>
          <div className="lg:flex lg:flex-wrap lg:items-center">
            ...
            <div className="lg:ml-[5vw]">
              ...
              <p className="my-1">
                Currencies:{" "}
                <span className="dark:text-gray-300">{displayCurrencies}</span>{" "}
              </p>
              <p className="my-1">
                Languages:{" "}
                <span className="dark:text-gray-300">{displayLanguages}</span>{" "}
              </p>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap pb-5 dark:text-gray-300 gap-y-4">
              {borderSegment}
            </div>
          </div>
        </div>
